...
export default function DareCardGame() {
  ...
  const shuffleCard = () => {
    ...
    // If taps are within 1200ms, count them
    ...
    setTimeout(() => {
      ...
      if (tapCount.current >= 3) {
        // 🔥 SECRET DARE ACTIVATED!
        picked =
          secretDares[Math.floor(Math.random() * secretDares.length)];
        tapCount.current = 0; // reset secret mode
      } else {
        // normal dare
